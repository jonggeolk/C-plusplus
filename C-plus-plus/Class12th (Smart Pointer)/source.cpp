...
#pragma region weak 포인터
	...
	// 되어 메모리가 해제되었음으로, 이 원시 포인터를 소유한 weak 포인터를
...
public:
	Player()
	{
		cout << "Create Plaer" << endl;
	}
	~Player()
	{
		cout << "Release Plaer" << endl;
	}
...
#pragma region unuque 포인터
	...
	//// 하나의 unique 포인ㅌ처는 하나의 객체만 가질 수 있습니다.
